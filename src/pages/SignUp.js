...
function SignUp() {
  ...
  return (
    <div className="fixed inset-0 flex items-center ">
      ...
      <div className="absolute m-auto rounded-l-[50px]  h-full right-0 w-[50%] bg-gradient-to-b from-[#ff811adb] to-[#FFFFFF00] px-40">
        <div className="">
          <div className=" flex justify-between py-3">
            <div className="">
              <h2 className="font-semibold">
                Chào Mừng Bạn Đến <br />
                <Link to="/" className="text-xl text-yellow-900 font-bold ">
                Hương Vị Việt Nam
                </Link>
              </h2>
            </div>
          ...
          <div className="">
            <h1 className="text-yellow-900 text-center text-3xl font-bold pt-6 pb-6  pdrop-shadow-sm">
              Sing Up 
            </h1>
